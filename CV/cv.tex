...
\begin{itemize}
    \item Languages: Java, C, Python, OCaml, Javascript/HTML/CSS, Bash, LaTeX
...
\job{Cornell University CS Department}{CS 3110 (Functional Programming) Consultant/TA}{August 2023 -- Present}{
    \begin{itemize}
        ...
        \item Guided multiple teams of three/four students in completing their final class project.
        \item Designed labs and held weekly discussion sections.
    \end{itemize}
}
